...
class C843(object):
    def __init__(self):
        ...
        self.ild = 0
        self.axs = '1234'
        self.stages = "M-111.1DG\nM-111.1DG\nM-111.1DG\nM-116.DG\n"
        #self.axs = '4'
        #self.stages = 'M-111.1DG\n'
        #self.stages = 'M-116.DG\n'
    ...
    def cst(self):
        """Connect Stages."""
        channels = ct.c_char_p(self.axs)
        stages = ct.c_char_p(self.stages)
    ...
    def qspa(self, ax, param):
        ...
        _params = {
                    ...
                    11: "max. Acceleration",
                    10: "max. Velocity",
                    14: "Numerator of the Conversion Factor",
                    15: "Denominator of the Conversion Factor",
